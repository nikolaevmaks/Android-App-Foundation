...
class EnumPreferenceNullable<T : Enum<T>>(key: String, private val clazz: Class<T>, defaultValue: T?) : RealBasePreference<T?>(key, defaultValue) {

	companion object {
		private val TAG = EnumPreferenceNullable::class.java.simpleName
	}
	...
	override fun load(): T? {
		return try {
			...
			(if (strResult == null) null else java.lang.Enum.valueOf(clazz, strResult))
